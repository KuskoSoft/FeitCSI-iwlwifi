...
IWL_FW_AND_PNVM(IWL_SO_A_JF_B_FW_PRE, IWL_AX210_UCODE_API_MAX);
IWL_FW_AND_PNVM(IWL_SO_A_HR_B_FW_PRE, IWL_AX210_UCODE_API_MAX);
IWL_FW_AND_PNVM(IWL_SO_A_GF_A_FW_PRE, IWL_AX210_UCODE_API_MAX);
IWL_FW_AND_PNVM(IWL_TY_A_GF_A_FW_PRE, IWL_AX210_UCODE_API_MAX);
IWL_FW_AND_PNVM(IWL_MA_A_HR_B_FW_PRE, IWL_AX210_UCODE_API_MAX);
...
IWL_FW_AND_PNVM(IWL_MA_B_HR_B_FW_PRE, IWL_AX210_UCODE_API_MAX);
